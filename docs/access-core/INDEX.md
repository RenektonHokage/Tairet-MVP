...
| What exactly closed in a previous slice? | The matching file under [`exec-plans/completed/`](exec-plans/completed/9E.5B3B4Q.md) | Current runtime state from historical evidence |
