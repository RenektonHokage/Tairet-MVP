...
- la contencion inicial empezo por `local_daily_ops`, `orders`, `locals` y `reservations`; el siguiente foco queda en confirmacion de alcance sobre `ticket_types` y `table_types`;
