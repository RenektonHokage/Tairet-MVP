...
const compactUiLabelClassName =
  "text-[10px] uppercase tracking-[0.2em] sm:text-[11px] sm:tracking-[0.28em]";
...
function LandingButton({
  ...
  const baseClassName = `inline-flex items-center justify-center rounded-full px-7 py-3 font-normal transition duration-300 ease-out sm:px-8 ${uiLabelClassName}`;
  const variants = {
    primary:
      "bg-[#efe8df] text-[#0b0b0b] hover:bg-white hover:shadow-[0_0_30px_rgba(255,255,255,0.12)]",
    secondary:
...
export default function TemporaryLanding() {
  ...
  return (
    <div
      className="relative min-h-screen overflow-x-hidden bg-[#050505] text-[#f4efe9]"
      style={uiFont}
    >
          ...
          <div className="mx-auto flex min-h-[calc(100vh-81px)] max-w-[1180px] items-center px-5 pb-16 pt-8 sm:px-8 sm:pb-24 sm:pt-10 md:pt-20">
            <div className="relative w-full overflow-hidden rounded-[36px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))] px-6 py-16 shadow-[0_30px_120px_rgba(0,0,0,0.42)] sm:px-10 sm:py-20 lg:px-16 lg:py-24">
              ...
              <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
                <div
                  className={`mb-10 flex items-center gap-3 text-[#f4efe9] sm:gap-4 ${compactUiLabelClassName}`}
                >
            ...
            <div className="mt-16 grid gap-px overflow-hidden rounded-[28px] border border-white/8 bg-white/8 sm:grid-cols-3">
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div className={`mt-3 text-[#8a857d] ${uiLabelClassName}`}>{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="mt-14 grid gap-px overflow-hidden rounded-[28px] border border-white/8 bg-white/8 lg:grid-cols-3">
              {cityCards.map((city) => (
                ...
                >
                  ...
                  <div
                    className="relative text-[44px] tracking-[-0.04em] text-[#8b867f] transition duration-500 group-hover:text-[#f4efe9]"
                    style={headingFont}
                  >
                    {city.number}
                  </div>
                  <div
                    className={`mt-8 inline-flex rounded-full border border-white/10 px-4 py-2 text-[#8d887f] ${uiLabelClassName}`}
                  >
                    {city.eyebrow}
                  </div>
                  <h3
                    className="relative mt-8 text-[36px] text-[#f6f0ea] transition duration-500 group-hover:text-white"
                    style={headingFont}
                  >
                    {city.title}
                  </h3>
        ...
        <section className="border-t border-white/8 py-24 sm:py-28">
          <div className="mx-auto max-w-[1180px] px-5 sm:px-8">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div
                className={`inline-flex w-fit items-center gap-3 rounded-full border border-white/10 px-5 py-3 text-[#f4efe9] ${uiLabelClassName}`}
              >
                <span className="relative flex h-2.5 w-2.5">
                  <span className="absolute inset-0 animate-pulse rounded-full bg-white/35 blur-[2px]" />
              ...
              {features.map((feature) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`mt-8 text-[#746f68] ${uiLabelClassName}`}>{feature.status}</p>
                  </article>
                );
              })}
            </div>
          ...
          <div className="mx-auto max-w-[1180px] px-5 sm:px-8">
            <div className="rounded-[36px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(92,18,18,0.12))] px-6 py-16 text-center shadow-[0_20px_80px_rgba(0,0,0,0.35)] sm:px-10 sm:py-20">
              <div className="mx-auto max-w-3xl">
                <div
                  className={`mb-8 inline-flex items-center gap-4 text-[#f4efe9] ${uiLabelClassName}`}
                >
      ...
      <footer className="relative z-10 border-t border-white/8 py-6">
        <div
          className={`mx-auto flex max-w-[1180px] flex-col items-center justify-between gap-5 px-5 text-center text-[#78736b] sm:px-8 lg:flex-row lg:text-left ${uiLabelClassName}`}
        >
          ...
          <div className="rounded-full border border-white/10 px-4 py-2 text-[#8c877f]">
            Próximamente
          </div>
        </div>
      </footer>
