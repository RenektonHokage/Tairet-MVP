...
import { afterOfficeVenues } from "@/lib/data/venues";
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url(${afterOffice})`
          }} 
        />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in">
            El lugar perfecto para desconectar con buenas vibras y excelente ambiente
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Mejores after office
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Locales perfectos para relajar después del trabajo
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {afterOfficeVenues.map((venue, index) => (
              <VenueExperienceCard
                key={venue.id}
                id={venue.id}
                name={venue.name}
